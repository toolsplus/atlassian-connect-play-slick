...
/**
  ...
  */
class SlickRepositorySpec
    extends Suites(new SlickAtlassianHostRepositorySpec,
                   new SlickForgeInstallationRepositorySpec,
                   new SlickForgeSystemAccessTokenRepositorySpec)
